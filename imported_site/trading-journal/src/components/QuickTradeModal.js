...
export default function QuickTradeModal({ isOpen, onClose, onSuccess, currency = 'EUR', profile = null }) {
          ...
          {previewResult !== null && (
            <div
              className={[
                ...
                previewResult > 0 ? 'bg-emerald-950/60' : previewResult < 0 ? 'bg-red-950/60' : 'bg-zinc-800',
              ].join(' ')}
            >
              ...
              <p
                className={[
                  'text-lg font-bold',
                  previewResult > 0 ? 'text-emerald-400' : previewResult < 0 ? 'text-red-400' : 'text-zinc-300',
                ].join(' ')}
              >
